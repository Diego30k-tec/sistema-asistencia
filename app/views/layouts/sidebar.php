<!--El archivo .htacces tiene esta linea RewriteRule ^(.+)$ app/index.php?url=$1 [QSA,L]-->
<!--Detectamos es que pagina estamos para marcar el link activo del siderbar(inicio, producto)-->
